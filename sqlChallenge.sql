...
-- Query 3
-- all nodes and their pageviews with organic medium in the last 30 days
...
select device_category, avg(ga.sessionLen) as avgSessionLength
...
inner join
  ...
  group by session_id
    ...
    on features.session_id = ga.session_id
